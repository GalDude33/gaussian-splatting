...
parser.add_argument("--colmap_matcher", default="exhaustive_matcher", type=str, help="exhaustive_matcher or sequential_matcher")
...
if not args.skip_matching:
    ...
    ## Feature matching
    feat_matching_cmd = colmap_command + " " + args.colmap_matcher + " \
        --database_path " + args.source_path + "/distorted/database.db \
